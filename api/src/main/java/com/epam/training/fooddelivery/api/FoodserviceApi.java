...
public interface FoodserviceApi {
     ...
     *
     * @return List of all foods (status code 200)
     */
    @ApiOperation(value = "List of all foods", nickname = "listAllFoods", notes = "", response = FoodModel.class, responseContainer = "List", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "List of all foods", response = FoodModel.class, responseContainer = "List") })
    @RequestMapping(
